...
public class CreateDepartmentRequestDTOValidatorTests
{
    private readonly CreateDepartmentRequestDTOValidator _validator;

	public CreateDepartmentRequestDTOValidatorTests()
	{
		_validator = new CreateDepartmentRequestDTOValidator();
	}
	...
	{
        // Arrange
        var createDepartmentRequestDto = new CreateDepartmentRequestDTO { Name = null };
    ...
    {
        // Arrange
        var createDepartmentRequestDto = new CreateDepartmentRequestDTO { Name = string.Empty };
    ...
    {
        // Arrange
        var createDepartmentRequestDto = new CreateDepartmentRequestDTO { Name = name };
